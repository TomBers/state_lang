defmodule StateLangWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `StateLangWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StateLangWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StateLangWeb.Gettext, "errors", msg, opts)
    end
  end
