defmodule StateLangNative do
  ...
  import StateLangWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {StateLangWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([StateLangWeb, CoreComponents, plugin.module_suffix])
